...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='customuser',
            name='cpf',
            field=models.CharField(max_length=11, unique=True, validators=[apps.users.validators.valid_cpf_validator, django.core.validators.RegexValidator(message='O CPF de conter 11 números', regex='^[0-9]{11}$'), django.core.validators.MinLengthValidator(11)], verbose_name='CPF'),
        ),
        migrations.AlterField(
            model_name='customuser',
            name='date_of_birth',
            field=models.DateField(validators=[apps.users.validators.legal_age_validator], verbose_name='date of birth'),
        ),
        migrations.AlterField(
            model_name='customuser',
            name='email',
